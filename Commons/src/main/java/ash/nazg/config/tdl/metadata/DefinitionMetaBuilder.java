...
public class DefinitionMetaBuilder {
    ...
    public DefinitionMetaBuilder def(String name, String descr, Class<?> type, String defaults, String defDescr) {
    ...
    public DefinitionMetaBuilder dynDef(String name, String descr, Class<?> type) {
        defs.put(name, getMeta(descr, type, null, null, false, true));

        return this;
    }

    private DefinitionMeta getMeta(String descr, Class<?> type, String defaults, String defDescr, boolean optional, boolean dynamic) {
        String typeName;
