...
import ash.nazg.scripting.ScriptHolder;
...
public class Configuration {
    ...
    public Configuration() {
        ...
        addOption("s", "script", true, "One Ring TDL4 script file");
    ...
    public ScriptHolder build(JavaSparkContext context) throws Exception {
        ...
        if (hasOption("s")) {
            ...
            throw new InvalidConfigurationException("One Ring TDL4 script wasn't supplied. There is nothing to run");
        }
