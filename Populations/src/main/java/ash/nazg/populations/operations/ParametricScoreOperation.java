...
public class ParametricScoreOperation extends Operation {
    ...
    public static final String COUNT_ATTR = "count.attr";
    public static final String VALUE_ATTR = "value.attr";
    public static final String GROUPING_ATTR = "grouping.attr";
    public static final String MULTIPLIER_COLUMN = "multiplier.column";
    ...
    public Map<String, DataStream> execute() {
        ...
        return Collections.singletonMap(outputStreams.firstKey(), new DataStream(StreamType.Columnar, output, Collections.singletonMap("value", outputColumns)));
    }
}
