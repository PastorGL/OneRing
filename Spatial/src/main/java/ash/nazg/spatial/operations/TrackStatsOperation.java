...
public class TrackStatsOperation extends Operation {
    ...
    public static final String PINNING_MODE = "pinning.mode";
    static final String DEF_USERID = "_userid";
    private static final String PINS_USERID_PROP = "pins.userid.prop";
    private static final String TRACKS_USERID_PROP = "tracks.userid.prop";
    ...
    private static final String TRACKS_TS_PROP = "tracks.ts.prop";
    ...
    public Map<String, DataStream> execute() {
        ...
        outColumns.put("track", inColumns.containsKey("track") ? new ArrayList<>(inColumns.get("track")) : new ArrayList<>());
        outColumns.get("track").add(GEN_POINTS);
        outColumns.get("track").add(GEN_RADIUS);
        outColumns.get("track").add(GEN_DISTANCE);
        outColumns.get("track").add(GEN_DURATION);
        outColumns.put("segment", inColumns.containsKey("segment") ? new ArrayList<>(inColumns.get("segment")) : new ArrayList<>());
        outColumns.get("segment").add(GEN_POINTS);
        outColumns.get("segment").add(GEN_RADIUS);
        outColumns.get("segment").add(GEN_DISTANCE);
        outColumns.get("segment").add(GEN_DURATION);
        outColumns.put("point", inColumns.containsKey("point") ? new ArrayList<>(inColumns.get("point")) : new ArrayList<>());
        outColumns.get("point").add(GEN_AZI_FROM_NEXT);
        outColumns.get("point").add(GEN_AZI_FROM_PREV);
        outColumns.get("point").add(GEN_AZI_TO_NEXT);
        outColumns.get("point").add(GEN_AZI_TO_PREV);
