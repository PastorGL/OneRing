...
public class GeoJsonToRoadMap implements Transform {
    public static final String NAME_PROP = "name.prop";
    public static final String TYPE_PROP = "type.prop";
    public static final String WIDTH_PROP = "width.prop";
    public static final String ROAD_TYPES = "road.types";
    public static final String TYPE_MULTIPLIER_PREFIX = "type.multiplier.";
    ...
    public StreamConverter converter() {
        return (ds, newColumns, params) -> {
            ...
            Map<String, List<String>> columns = (_outputColumns != null) ? newColumns : Collections.singletonMap("polygon", Arrays.asList(typeColumn, widthColumn, nameColumn));
