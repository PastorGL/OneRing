...
public class SubtractFunction extends ColumnsMathFunction {
    public SubtractFunction(char inputDelimiter, char outputDelimiter, int[] outputColumns, int[] columnsForCalculation, Double _const) {
